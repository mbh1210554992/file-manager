    ...
    <div class="container">
	   ...
	   <div class="page-header">
			<div class="page-title" style="padding-bottom: 5px">
				<ol class="breadcrumb">
				  <li class="active" id="titleId">部门信息管理</li>
				</ol>
			</div>
		</div>
		<form method="post" id="formHead">
			...
			<div class="row col-md-12">
				<table id="DeptTable" data-click-to-select="true">
					<thead>
					<tr>
...
<script type="text/javascript" src="${basePath}/js/system/dept_list.js"></script>